...
model_pricings = {
    "gpt-4o-mini": {
         "input_tokens": 0.150 / 1_000_000,  # koszt za token wejściowy
        "output_tokens": 0.600 / 1_000_000,  # koszt za token wyjściowy
    },
    "gpt-4o": {     
        "input_tokens": 5.00 / 1_000_000,  # koszt za token wejściowy
        "output_tokens": 15.00 / 1_000_000,  # koszt za token wyjściowy
    }
}

# Lista dostępnych modeli
model_choices = list(model_pricings.keys())

# Tworzenie rozwijanej listy (selectbox) w bocznym panelu Streamlit
MODEL = st.sidebar.selectbox('Wybierz model:', model_choices)

# Konwersja USD do PLN
USD_TO_PLN = 3.97

# Uzyskanie odpowiednich cen dla wybranego modelu
